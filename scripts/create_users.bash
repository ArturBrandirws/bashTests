...
create_user() {
  ...
  if ! id "$1" &>/dev/null; then
    ...
    useradd -m -d "$2/$1" -g "$3" -s /bin/false "$1"
...
configure_ssh_key() {
  ...
  wget -O "$1/$2/.ssh/authorized_keys" "https://raw.githubusercontent.com/ArturBrandirws/bashTests/main/id_rsa.pub"
...
main() {
  ...
  # Iterate over the parsed_list
  for element in "${parsed_list[@]}"; do
